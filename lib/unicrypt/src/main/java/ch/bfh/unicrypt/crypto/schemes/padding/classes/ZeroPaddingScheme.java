...
public class ZeroPaddingScheme
	...
	private ZeroPaddingScheme(ByteArrayMonoid byteArrayMonoid) {
	...
	public static ZeroPaddingScheme getInstance(ByteArrayMonoid byteArrayMonoid) {
		...
		return new ZeroPaddingScheme(byteArrayMonoid);
	}

	public static ZeroPaddingScheme getInstance(int blockLength) {
		return new ZeroPaddingScheme(ByteArrayMonoid.getInstance(blockLength));
	}
