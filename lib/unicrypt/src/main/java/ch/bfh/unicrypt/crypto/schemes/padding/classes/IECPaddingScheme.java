...
public class IECPaddingScheme
	...
	public static IECPaddingScheme getInstance(ByteArrayMonoid byteArrayMonoid) {
		if (byteArrayMonoid == null) {
			throw new IllegalArgumentException();
		}
		return new IECPaddingScheme(byteArrayMonoid);
	}

	public static IECPaddingScheme getInstance(int blockLength) {
		return new IECPaddingScheme(ByteArrayMonoid.getInstance(blockLength));
	}
