 ...
 */
package lib.unicrypt.src.main.java.ch.bfh.unicrypt.crypto.schemes.signature.interfaces;
...
public interface RandomizedSignatureScheme
	...
	public Element sign(final Element privateKey, final Element message, RandomByteSequence randomByteSequence);
