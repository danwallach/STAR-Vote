 ...
 */
public interface ICryptoType<T extends AHomomorphicCiphertext<T>> extends Serializable {
     ...
     */
    public byte[] decrypt(T cipherText) throws InvalidKeyException, KeyNotLoadedException, CipherException, CiphertextException;
     ...
     * @throws crypto.exceptions.KeyNotLoadedException
     */
    public T encrypt(byte[] plainText) throws InvalidKeyException, KeyNotLoadedException, CipherException;
